  ...
  return (
	<div className="input-block">
	  <label htmlFor="">
		...
		{props.labelLink && <span className="link"><Link to={props.labelLink}>{props.labelLinkText}</Link></span>}
	  </label>
	  <input
		...
		multiple={isMultiple}
	  />
	  {props.requiredMessage && <span className="error-message"><InfoCircle fill="" /> {props.requiredMessageLabel}</span>}
	  { props.textType === 'password' && <span className="password-visiablity" onClick={passwordVisiablityClick}>
